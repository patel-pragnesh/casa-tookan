...
function Controller() {
  ...
  { width: Ti.UI.FILL, height: Alloy.Globals.topBarHeight, top: 0, backgroundColor: Alloy.Globals.mainColor, id: "__alloyId164" });

  $.__views.mainView.add($.__views.__alloyId164);
  ...
  $.__views.__alloyId164.add($.__views.gobackButton);
  ...
  $.__views.__alloyId164.add($.__views.signoutButton);
  ...
  { clearButtonMode: Ti.UI.INPUT_BUTTONMODE_ONFOCUS, keyboardType: Ti.UI.KEYBOARD_TYPE_DEFAULT, returnKeyType: Ti.UI.RETURNKEY_DONE, borderStyle: Ti.UI.INPUT_BORDERSTYLE_BEZEL, backgroundColor: "#ffffff", color: "#333300", height: 35, width: 250, padding: { left: 5 }, keyboardToolbarColor: "#999", keyboardToolbarHeight: 40, top: 10, hintText: "pincode", id: "__alloyId167" });

  $.__views.balancesView.add($.__views.__alloyId167);
  $.__views.addAvatarButton = Ti.UI.createButton(
  ...
  { width: Ti.UI.SIZE, height: Ti.UI.SIZE, id: "__alloyId169" });

  $.__views.tableViewFooter.add($.__views.__alloyId169);
  $.__views.__alloyId170 = Ti.UI.createActivityIndicator(
  { style: Ti.UI.ActivityIndicatorStyle.DARK, visible: false, id: "__alloyId170" });
  ...
  $.__views.__alloyId169.add($.__views.addCasa);
