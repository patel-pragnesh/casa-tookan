...
function Controller() {
  ...
  { width: "100%", height: 40, top: Alloy.Globals.tabBarHeight, backgroundColor: "#f3f3f3", id: "newsBar" });

  $.__views.newsBar && $.addTopLevelView($.__views.newsBar);
  $.__views.tabnew = Ti.UI.createView(
  { width: "25%", left: 0, id: "tabnew", layout: "vertical" });

  $.__views.newsBar.add($.__views.tabnew);
  $.__views.__alloyId93 = Ti.UI.createLabel(
  { width: Ti.UI.SIZE, height: "100%", color: "#000000", font: { fontFamily: "HelveticaNeue-Light", fontSize: 18, fontWeight: "normal" }, text: 'NEW', id: "__alloyId93" });

  $.__views.tabnew.add($.__views.__alloyId93);
  $.__views.tabstar = Ti.UI.createView(
  { width: "25%", left: "25%", id: "tabstar", layout: "vertical" });

  $.__views.newsBar.add($.__views.tabstar);
  $.__views.__alloyId94 = Ti.UI.createLabel(
  { width: Ti.UI.SIZE, height: "100%", color: "#000000", font: { fontFamily: "HelveticaNeue-Light", fontSize: 18, fontWeight: "normal" }, text: 'STAR', id: "__alloyId94" });

  $.__views.tabstar.add($.__views.__alloyId94);
  $.__views.tabread = Ti.UI.createView(
  { width: "25%", left: "50%", id: "tabread", layout: "vertical" });

  $.__views.newsBar.add($.__views.tabread);
  $.__views.__alloyId95 = Ti.UI.createLabel(
  { width: Ti.UI.SIZE, height: "100%", color: "#000000", font: { fontFamily: "HelveticaNeue-Light", fontSize: 18, fontWeight: "normal" }, text: 'READ', id: "__alloyId95" });

  $.__views.tabread.add($.__views.__alloyId95);
  $.__views.tabfilt = Ti.UI.createView(
  { width: "25%", right: 0, id: "tabfilt", layout: "vertical" });

  $.__views.newsBar.add($.__views.tabfilt);
  $.__views.__alloyId96 = Ti.UI.createLabel(
  { width: Ti.UI.SIZE, height: "100%", color: "#000000", font: { fontFamily: "HelveticaNeue-Light", fontSize: 18, fontWeight: "normal" }, text: 'FILTER', id: "__alloyId96" });

  $.__views.tabfilt.add($.__views.__alloyId96);
  $.__views.tableViewFooter = Ti.UI.createView(
  { height: 50, width: Ti.UI.FILL, id: "tableViewFooter", visible: false });

  $.__views.__alloyId98 = Ti.UI.createView(
  { width: Ti.UI.SIZE, height: Ti.UI.SIZE, layout: "horizontal", id: "__alloyId98" });

  $.__views.tableViewFooter.add($.__views.__alloyId98);
  $.__views.__alloyId99 = Ti.UI.createActivityIndicator(
  { style: Ti.UI.ActivityIndicatorStyle.DARK, visible: true, id: "__alloyId99" });

  $.__views.__alloyId98.add($.__views.__alloyId99);
  $.__views.__alloyId100 = Ti.UI.createLabel(
  { width: Ti.UI.SIZE, height: Ti.UI.SIZE, color: "gray", font: { fontFamily: "HelveticaNeue-Light", fontSize: 18, fontWeight: "normal" }, left: 5, text: L("label_loading"), id: "__alloyId100" });
  ...
  { width: Ti.UI.SIZE, height: Ti.UI.SIZE, color: "#929292", font: { fontFamily: "HelveticaNeue-Light", fontSize: 15, fontWeight: "normal" }, textAlign: Ti.UI.TEXT_ALIGNMENT_CENTER, text: L("label_error_loading"), id: "__alloyId101" });

  $.__views.errorMessage.add($.__views.__alloyId101);
  ...
  { width: Ti.UI.SIZE, height: Ti.UI.SIZE, color: "#929292", font: { fontFamily: "HelveticaNeue-Light", fontSize: 15, fontWeight: "normal" }, textAlign: Ti.UI.TEXT_ALIGNMENT_CENTER, text: L("label_history_empty"), id: "__alloyId102" });

  $.__views.emptyMessage.add($.__views.__alloyId102);
  ...
  { width: Ti.UI.SIZE, height: Ti.UI.SIZE, layout: "horizontal", id: "__alloyId103" });

  $.__views.activityIndicator.add($.__views.__alloyId103);
  $.__views.__alloyId104 = Ti.UI.createActivityIndicator(
  { style: Ti.UI.ActivityIndicatorStyle.DARK, visible: true, id: "__alloyId104" });
  ...
  $.__views.__alloyId103.add($.__views.loadingLabel);
  ...
  function () {
    ...
    Alloy.deepExtend(true, o, { text: L("label_tab_news"), id: "__alloyId105" });
    return o;
  }());

  $.__views.newsTopBar.add($.__views.__alloyId105);
