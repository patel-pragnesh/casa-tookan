...
function Controller() {
    ...
    reload ? $.addListener($.__views.reloadButton, 'click', reload) : __defers['$.__views.reloadButton!click!reload'] = true;
    ...
    $.__views.web = Ti.UI.createView({ id: 'web' });
    ...
    if (true) {
        var TiApp = require('/hyperloop/titanium/tiapp');
        var WebKit = require('/hyperloop/webkit/webkit');
        var web3 = require('/hyperloop/web3/browser');
        var web3Obj = new web3();
        var lock = false;
        var WKWebView = require('/hyperloop/webkit/wkwebview'), WKNavigation = require('/hyperloop/webkit/wknavigation'), NSURLRequest = require('/hyperloop/foundation/nsurlrequest'), NSURL = require('/hyperloop/foundation/nsurl'), UIScreen = require('/hyperloop/uikit/uiscreen'), CGRectMake = require('/hyperloop/coregraphics/coregraphics').CGRectMake;
        ...
        function loadWebViewIOS() {
            ...
            delegate.didFinishNavigation = function (webView, navigation) {
                ...
                $.reloadButton.show();
                updateButtons();
                webView.fireEvent('load', { url: getCurrentUrl() });
                startCheckData();
            };
