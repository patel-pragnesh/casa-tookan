...
function Controller() {
  ...
  { width: Ti.UI.FILL, height: 1, backgroundColor: "#000000", top: 0, opacity: 0.2, id: "__alloyId125" });

  $.__views.mainView.add($.__views.__alloyId125);
  ...
  { width: Ti.UI.SIZE, height: Ti.UI.SIZE, left: 10, touchEnabled: false, layout: "vertical", id: "__alloyId126" });

  $.__views.highButton.add($.__views.__alloyId126);
  $.__views.__alloyId127 = Ti.UI.createLabel(
  { width: Ti.UI.SIZE, height: Ti.UI.SIZE, color: "#000000", font: { fontFamily: "HelveticaNeue-Light", fontSize: 15, fontWeight: "bold" }, left: 10, text: L("label_priority_high"), touchEnabled: false, id: "__alloyId127" });
  ...
  $.__views.__alloyId126.add($.__views.highDesc);
  ...
  { width: Ti.UI.SIZE, height: Ti.UI.SIZE, left: 10, touchEnabled: false, layout: "vertical", id: "__alloyId128" });

  $.__views.medButton.add($.__views.__alloyId128);
  $.__views.__alloyId129 = Ti.UI.createLabel(
  { width: Ti.UI.SIZE, height: Ti.UI.SIZE, color: "#000000", font: { fontFamily: "HelveticaNeue-Light", fontSize: 15, fontWeight: "bold" }, left: 10, text: L("label_priority_med"), touchEnabled: false, id: "__alloyId129" });
  ...
  $.__views.__alloyId128.add($.__views.medDesc);
  ...
  { width: Ti.UI.SIZE, height: Ti.UI.SIZE, left: 10, touchEnabled: false, layout: "vertical", id: "__alloyId130" });

  $.__views.lowButton.add($.__views.__alloyId130);
  $.__views.__alloyId131 = Ti.UI.createLabel(
  { width: Ti.UI.SIZE, height: Ti.UI.SIZE, color: "#000000", font: { fontFamily: "HelveticaNeue-Light", fontSize: 15, fontWeight: "bold" }, left: 10, text: L("label_priority_low"), touchEnabled: false, id: "__alloyId131" });
  ...
  $.__views.__alloyId130.add($.__views.lowDesc);
  ...
  { width: Ti.UI.FILL, height: 1, backgroundColor: "#000000", top: 0, opacity: 0.2, id: "__alloyId132" });

  $.__views.bitcoinFees.add($.__views.__alloyId132);
  ...
  { width: Ti.UI.SIZE, height: Ti.UI.SIZE, left: 10, touchEnabled: false, layout: "vertical", id: "__alloyId133" });

  $.__views.customButtonBtc.add($.__views.__alloyId133);
  $.__views.__alloyId134 = Ti.UI.createLabel(
  { width: Ti.UI.SIZE, height: Ti.UI.SIZE, color: "#000000", font: { fontFamily: "HelveticaNeue-Light", fontSize: 15, fontWeight: "bold" }, left: 10, text: L("label_priority_custom"), touchEnabled: false, id: "__alloyId134" });

  $.__views.__alloyId133.add($.__views.__alloyId134);
  $.__views.__alloyId135 = Ti.UI.createLabel(
  { width: Ti.UI.SIZE, height: Ti.UI.SIZE, color: "#000000", font: { fontFamily: "HelveticaNeue-Light", fontSize: 10, fontWeight: "normal" }, left: 10, text: L("label_priority_custom_description"), touchEnabled: false, id: "__alloyId135" });
  ...
  { width: Ti.UI.SIZE, height: Ti.UI.SIZE, left: 10, touchEnabled: false, layout: "vertical", id: "__alloyId136" });

  $.__views.recommendedEthButton.add($.__views.__alloyId136);
  ...
  $.__views.__alloyId136.add($.__views.recommendedEthLabel);
  $.__views.highDesc = Ti.UI.createLabel(
  ...
  $.__views.__alloyId136.add($.__views.highDesc);
  ...
  { width: Ti.UI.FILL, height: 1, backgroundColor: "#000000", top: 0, opacity: 0.2, id: "__alloyId137" });

  $.__views.ethereumFees.add($.__views.__alloyId137);
  ...
  { width: Ti.UI.SIZE, height: Ti.UI.SIZE, left: 10, touchEnabled: false, layout: "vertical", id: "__alloyId138" });

  $.__views.customButtonEth.add($.__views.__alloyId138);
  $.__views.__alloyId139 = Ti.UI.createLabel(
  { width: Ti.UI.SIZE, height: Ti.UI.SIZE, color: "#000000", font: { fontFamily: "HelveticaNeue-Light", fontSize: 15, fontWeight: "bold" }, left: 10, text: L("label_custom_gas_price"), touchEnabled: false, id: "__alloyId139" });

  $.__views.__alloyId138.add($.__views.__alloyId139);
  $.__views.__alloyId140 = Ti.UI.createLabel(
  { width: Ti.UI.SIZE, height: Ti.UI.SIZE, color: "#000000", font: { fontFamily: "HelveticaNeue-Light", fontSize: 10, fontWeight: "normal" }, left: 10, text: L("label_custom_gas_price_description"), touchEnabled: false, id: "__alloyId140" });
