 ...
 * @class
 */
function SCNMatrix4 (pointer) {
	if (pointer) {
		var oldWrapper = Hyperloop.getWrapper(pointer);
		if (oldWrapper) return oldWrapper;
	}
	if (!(this instanceof SCNMatrix4)) { throw new TypeError('Cannot instantiate a class by calling it as a function'); }
	if (!$init) {
		$initialize();
	}
	
	if (!pointer) {
		pointer = Hyperloop.createPointer('{SCNMatrix4=ffffffffffffffff}', 'SceneKit', '/Applications/Xcode.app/Contents/Developer/Platforms/iPhoneSimulator.platform/Developer/SDKs/iPhoneSimulator11.3.sdk/System/Library/Frameworks/SceneKit.framework/Headers/SceneKitTypes');
	}
...
function $initialize () {
	...
	SCNMatrix4._imports = $imports;

	// properties
	Object.defineProperties(SCNMatrix4.prototype, {
