 ...
 * @class
 */
function LcarCaretTable (pointer) {
	if (pointer) {
		var oldWrapper = Hyperloop.getWrapper(pointer);
		if (oldWrapper) return oldWrapper;
	}
	if (!(this instanceof LcarCaretTable)) { throw new TypeError('Cannot instantiate a class by calling it as a function'); }
	if (!$init) {
		$initialize();
	}
	this.$lookup = {};
...
function $initialize () {
	...
	LcarCaretTable._imports = $imports;

	// properties
	Object.defineProperties(LcarCaretTable.prototype, {
