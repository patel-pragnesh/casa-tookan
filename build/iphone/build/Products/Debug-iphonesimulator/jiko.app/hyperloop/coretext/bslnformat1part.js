 ...
 * @class
 */
function BslnFormat1Part (pointer) {
	if (pointer) {
		var oldWrapper = Hyperloop.getWrapper(pointer);
		if (oldWrapper) return oldWrapper;
	}
	if (!(this instanceof BslnFormat1Part)) { throw new TypeError('Cannot instantiate a class by calling it as a function'); }
	if (!$init) {
		$initialize();
	}
	this.$mappingData = {};
...
function $initialize () {
	...
	BslnFormat1Part._imports = $imports;

	// properties
	Object.defineProperties(BslnFormat1Part.prototype, {
...
module.exports = BslnFormat1Part;
