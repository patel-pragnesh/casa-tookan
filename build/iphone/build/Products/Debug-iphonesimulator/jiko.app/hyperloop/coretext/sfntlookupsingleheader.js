 ...
 * @class
 */
function SFNTLookupSingleHeader (pointer) {
	if (pointer) {
		var oldWrapper = Hyperloop.getWrapper(pointer);
		if (oldWrapper) return oldWrapper;
	}
	if (!(this instanceof SFNTLookupSingleHeader)) { throw new TypeError('Cannot instantiate a class by calling it as a function'); }
	if (!$init) {
		$initialize();
	}
	this.$binSearch = {};
...
function $initialize () {
	...
	SFNTLookupSingleHeader._imports = $imports;

	// properties
	Object.defineProperties(SFNTLookupSingleHeader.prototype, {
...
module.exports = SFNTLookupSingleHeader;
