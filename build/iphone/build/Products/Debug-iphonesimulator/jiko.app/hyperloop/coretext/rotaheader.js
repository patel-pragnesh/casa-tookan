 ...
 * @class
 */
function ROTAHeader (pointer) {
	if (pointer) {
		var oldWrapper = Hyperloop.getWrapper(pointer);
		if (oldWrapper) return oldWrapper;
	}
	if (!(this instanceof ROTAHeader)) { throw new TypeError('Cannot instantiate a class by calling it as a function'); }
	if (!$init) {
		$initialize();
	}
	this.$lookup = {};
...
function $initialize () {
	...
	ROTAHeader._imports = $imports;

	// properties
	Object.defineProperties(ROTAHeader.prototype, {
