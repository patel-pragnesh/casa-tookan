 ...
 * @class
 */
function MortInsertionSubtable (pointer) {
	if (pointer) {
		var oldWrapper = Hyperloop.getWrapper(pointer);
		if (oldWrapper) return oldWrapper;
	}
	if (!(this instanceof MortInsertionSubtable)) { throw new TypeError('Cannot instantiate a class by calling it as a function'); }
	if (!$init) {
		$initialize();
	}
	this.$header = {};
	...
	if (!pointer) {
		pointer = Hyperloop.createPointer('{MortInsertionSubtable={STHeader=CCSSS}}', 'CoreText', '/Applications/Xcode.app/Contents/Developer/Platforms/iPhoneSimulator.platform/Developer/SDKs/iPhoneSimulator11.3.sdk/System/Library/Frameworks/CoreText.framework/Headers/SFNTLayoutTypes');
	}
...
function $initialize () {
	...
	MortInsertionSubtable._imports = $imports;

	// properties
	Object.defineProperties(MortInsertionSubtable.prototype, {
...
module.exports = MortInsertionSubtable;
