 ...
 * @class
 */
function AudioFormatListItem (pointer) {
	if (pointer) {
		var oldWrapper = Hyperloop.getWrapper(pointer);
		if (oldWrapper) return oldWrapper;
	}
	if (!(this instanceof AudioFormatListItem)) { throw new TypeError('Cannot instantiate a class by calling it as a function'); }
	if (!$init) {
		$initialize();
	}
	this.$mASBD = {};
	...
	if (!pointer) {
		pointer = Hyperloop.createPointer('{AudioFormatListItem={AudioStreamBasicDescription=dIIIIIIII}I}', 'AudioToolbox', '/Applications/Xcode.app/Contents/Developer/Platforms/iPhoneSimulator.platform/Developer/SDKs/iPhoneSimulator11.3.sdk/System/Library/Frameworks/AudioToolbox.framework/Headers/AudioFormat');
	}
...
function $initialize () {
	...
	AudioFormatListItem._imports = $imports;

	// properties
	Object.defineProperties(AudioFormatListItem.prototype, {
...
module.exports = AudioFormatListItem;
