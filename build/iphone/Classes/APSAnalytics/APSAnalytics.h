 ...
 * to send analytic data that can be viewed on the jiko Dashboard.
 *
 * For information on getting started with jiko Platform Services,
 * see [jiko Platform Services for iOS](http://bit.ly/1kqteQS).
 */
