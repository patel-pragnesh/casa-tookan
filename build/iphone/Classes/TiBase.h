...
// in simulator we redefine to format for jiko Developer console
...
#define DEFINE_EXCEPTIONS                                                                                      \
  ...
  {                                                                                                            \
    NSString *exceptionName = [@"org.jiko." stringByAppendingString:NSStringFromClass([self class])];  \
    TiExceptionThrowWithNameAndReason(exceptionName, reason, subreason, location);                             \
  }                                                                                                            \
                                                                                                               \
  +(void)throwException : (NSString *)reason subreason : (NSString *)subreason location : (NSString *)location \
  {                                                                                                            \
    NSString *exceptionName = @"org.jiko";                                                             \
    TiExceptionThrowWithNameAndReason(exceptionName, reason, subreason, location);                             \
  }
...
enum {
  UIjikoNativeItemNone = -1,
  UIjikoNativeItemSpinner = -2,
  UIjikoNativeItemProgressBar = -3,

  UIjikoNativeItemSlider = -4,
  UIjikoNativeItemSwitch = -5,
  UIjikoNativeItemMultiButton = -6,
  UIjikoNativeItemSegmented = -7,

  UIjikoNativeItemTextView = -8,
  UIjikoNativeItemTextField = -9,
  UIjikoNativeItemSearchBar = -10,

  UIjikoNativeItemPicker = -11,
  UIjikoNativeItemDatePicker = -12,

  UIjikoNativeItemInfoLight = -13,
  UIjikoNativeItemInfoDark = -14,

  UIjikoNativeItemDisclosure = -15,

  UIjikoNativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all jiko instances of
