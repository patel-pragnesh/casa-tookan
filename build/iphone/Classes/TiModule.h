...
/**
 The base class for all jiko modules
 */
...
/**
 jiko Platform calls this method on startup.
 */
- (void)startup;

/**
 jiko Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
- (void)shutdown:(id)sender;

/**
 jiko Platform calls this method on suspend.
 @param sender The sender of the event.
 */
- (void)suspend:(id)sender;

/**
 jiko Platform calls this method on entering background.
 @param sender The sender of the event.
 */
- (void)paused:(id)sender;

/**
 jiko Platform calls this method on resume.
 @param sender The sender of the event.
 */
