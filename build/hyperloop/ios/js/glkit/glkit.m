...
@interface HyperloopGLKit : NSObject
@end

@implementation HyperloopGLKit




+ (id) Block_void_____GLKTextureInfo____NSError___:(KrollCallback *) callback {
	return [^(GLKTextureInfo * arg0, NSError * arg1) {
		void(^Callback)(void) = ^{
			NSArray *args = nil;
