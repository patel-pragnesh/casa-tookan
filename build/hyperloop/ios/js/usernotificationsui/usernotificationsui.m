...
@interface HyperloopUserNotificationsUI : NSObject
@end

@implementation HyperloopUserNotificationsUI




+ (id) Block_void_____UNNotificationContentExtensionResponseOption_:(KrollCallback *) callback {
	return [^(UNNotificationContentExtensionResponseOption arg0) {
		void(^Callback)(void) = ^{
			NSArray *args = nil;
			id _arg0 = @(arg0);
			args = @[_arg0];
