...
@interface HyperloopNotificationCenter : NSObject
@end

@implementation HyperloopNotificationCenter




+ (id) Block_void_____NCUpdateResult_:(KrollCallback *) callback {
	return [^(NCUpdateResult arg0) {
		void(^Callback)(void) = ^{
			NSArray *args = nil;
			id _arg0 = @(arg0);
			args = @[_arg0];
