...
@interface HyperloopContacts : NSObject
@end

@implementation HyperloopContacts
...
+ (id) Block_void_____CNContact____BOOL___:(KrollCallback *) callback {
	return [^(CNContact * arg0, BOOL * arg1) {
		void(^Callback)(void) = ^{
			NSArray *args = nil;
