...
@interface HyperloopSpeech : NSObject
@end

@implementation HyperloopSpeech




+ (id) Block_void_____SFSpeechRecognitionResult____NSError___:(KrollCallback *) callback {
	return [^(SFSpeechRecognitionResult * arg0, NSError * arg1) {
		void(^Callback)(void) = ^{
			NSArray *args = nil;
...
+ (id) Block_void_____SFSpeechRecognizerAuthorizationStatus_:(KrollCallback *) callback {
	return [^(SFSpeechRecognizerAuthorizationStatus arg0) {
		void(^Callback)(void) = ^{
			NSArray *args = nil;
			id _arg0 = @(arg0);
			args = @[_arg0];
