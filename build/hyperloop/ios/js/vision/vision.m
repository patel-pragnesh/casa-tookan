...
@interface HyperloopVision : NSObject
@end

@implementation HyperloopVision




+ (id) Block_void_____VNRequest____NSError___:(KrollCallback *) callback {
	return [^(VNRequest * arg0, NSError * arg1) {
		void(^Callback)(void) = ^{
			NSArray *args = nil;
