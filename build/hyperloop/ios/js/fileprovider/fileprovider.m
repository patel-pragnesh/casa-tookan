...
@interface HyperloopFileProvider : NSObject
@end

@implementation HyperloopFileProvider




+ (id) Block_void_____NSArray_NSFileProviderDomain_______NSError___:(KrollCallback *) callback {
	return [^(NSArray<NSFileProviderDomain *> * arg0, NSError * arg1) {
		void(^Callback)(void) = ^{
			NSArray *args = nil;
...
+ (id) Block_void_____NSFileProviderItem__NSError___:(KrollCallback *) callback {
	return [^(NSFileProviderItem arg0, NSError * arg1) {
		void(^Callback)(void) = ^{
			NSArray *args = nil;
			id _arg0 = (arg0 == nil || [(id)arg0 isEqual:[NSNull null]]) ? (id)[NSNull null] : (id)[HyperloopPointer pointer:(__bridge void *)arg0 encoding:@encode(id)];
			id _arg1 = (arg1 == nil || [(id)arg1 isEqual:[NSNull null]]) ? (id)[NSNull null] : (id)[HyperloopPointer pointer:(__bridge void *)arg1 encoding:@encode(id)];
...
+ (id) Block_void_____NSFileProviderItemIdentifier__NSData____NSError___:(KrollCallback *) callback {
	return [^(NSFileProviderItemIdentifier arg0, NSData * arg1, NSError * arg2) {
		void(^Callback)(void) = ^{
			NSArray *args = nil;
			id _arg0 = (arg0 == nil || [(id)arg0 isEqual:[NSNull null]]) ? (id)[NSNull null] : (id)[HyperloopPointer pointer:(__bridge void *)arg0 encoding:@encode(id)];
			id _arg1 = (arg1 == nil || [(id)arg1 isEqual:[NSNull null]]) ? (id)[NSNull null] : (id)[HyperloopPointer pointer:(__bridge void *)arg1 encoding:@encode(id)];
...
+ (id) Block_void_____NSFileProviderSyncAnchor_:(KrollCallback *) callback {
	return [^(NSFileProviderSyncAnchor arg0) {
		void(^Callback)(void) = ^{
			NSArray *args = nil;
			id _arg0 = (arg0 == nil || [(id)arg0 isEqual:[NSNull null]]) ? (id)[NSNull null] : (id)[HyperloopPointer pointer:(__bridge void *)arg0 encoding:@encode(id)];
			args = @[_arg0];
