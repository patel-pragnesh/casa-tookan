...
@interface HyperloopCoreData : NSObject
@end

@implementation HyperloopCoreData




+ (id) Block_void_____NSAsynchronousFetchResult___:(KrollCallback *) callback {
	return [^(NSAsynchronousFetchResult * arg0) {
		void(^Callback)(void) = ^{
			NSArray *args = nil;
...
+ (id) Block_void_____NSAsynchronousFetchResult_ResultType____:(KrollCallback *) callback {
	return [^(NSAsynchronousFetchResult<ResultType> * arg0) {
		void(^Callback)(void) = ^{
			NSArray *args = nil;
			id _arg0 = (arg0 == nil || [(id)arg0 isEqual:[NSNull null]]) ? (id)[NSNull null] : (id)[HyperloopPointer pointer:(__bridge void *)arg0 encoding:@encode(id)];
			args = @[_arg0];
...
+ (id) Block_void_____NSManagedObjectContext___:(KrollCallback *) callback {
	return [^(NSManagedObjectContext * arg0) {
		void(^Callback)(void) = ^{
			NSArray *args = nil;
			id _arg0 = (arg0 == nil || [(id)arg0 isEqual:[NSNull null]]) ? (id)[NSNull null] : (id)[HyperloopPointer pointer:(__bridge void *)arg0 encoding:@encode(id)];
			args = @[_arg0];
...
+ (id) Block_void_____NSPersistentStoreDescription____NSError___:(KrollCallback *) callback {
	return [^(NSPersistentStoreDescription * arg0, NSError * arg1) {
		void(^Callback)(void) = ^{
			NSArray *args = nil;
			id _arg0 = (arg0 == nil || [(id)arg0 isEqual:[NSNull null]]) ? (id)[NSNull null] : (id)[HyperloopPointer pointer:(__bridge void *)arg0 encoding:@encode(id)];
