...
@interface HyperloopQuickLook : NSObject
@end

@implementation HyperloopQuickLook




+ (id) Block_BOOL_____CGContextRef_:(KrollCallback *) callback {
	return [^(CGContextRef arg0) {
		void(^Callback)(void) = ^{
			NSArray *args = nil;
			id _arg0 = (arg0 == nil) ? (id)[NSNull null] : (id)[HyperloopPointer pointer:(const void *)&arg0 encoding:@encode(CGContextRef)];
			args = @[_arg0];
...
+ (id) Block_void_____QLThumbnailReply____NSError___:(KrollCallback *) callback {
	return [^(QLThumbnailReply * arg0, NSError * arg1) {
		void(^Callback)(void) = ^{
			NSArray *args = nil;
			id _arg0 = (arg0 == nil || [(id)arg0 isEqual:[NSNull null]]) ? (id)[NSNull null] : (id)[HyperloopPointer pointer:(__bridge void *)arg0 encoding:@encode(id)];
