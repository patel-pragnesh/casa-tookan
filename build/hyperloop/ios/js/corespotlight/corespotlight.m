...
@interface HyperloopCoreSpotlight : NSObject
@end

@implementation HyperloopCoreSpotlight




+ (id) Block_void_____NSArray_CSSearchableItem______:(KrollCallback *) callback {
	return [^(NSArray<CSSearchableItem *> * arg0) {
		void(^Callback)(void) = ^{
			NSArray *args = nil;
