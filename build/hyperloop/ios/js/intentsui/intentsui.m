...
@interface HyperloopIntentsUI : NSObject
@end

@implementation HyperloopIntentsUI




+ (id) Block_void_____BOOL__NSSet_INParameter_______CGSize_:(KrollCallback *) callback {
	return [^(BOOL arg0, NSSet<INParameter *> * arg1, CGSize arg2) {
		void(^Callback)(void) = ^{
			NSArray *args = nil;
			...
			id _arg2 = [HyperloopPointer pointer:(const void *)&arg2 encoding:@encode(CGSize)];
...
+ (id) Block_void_____CGSize_:(KrollCallback *) callback {
	return [^(CGSize arg0) {
		void(^Callback)(void) = ^{
			NSArray *args = nil;
...
+ (id) Block_void_____UIImage___:(KrollCallback *) callback {
	return [^(UIImage * arg0) {
		void(^Callback)(void) = ^{
			NSArray *args = nil;
