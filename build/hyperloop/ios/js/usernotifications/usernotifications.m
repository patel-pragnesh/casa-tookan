...
@interface HyperloopUserNotifications : NSObject
@end

@implementation HyperloopUserNotifications
...
+ (id) Block_void_____NSArray_UNNotification______:(KrollCallback *) callback {
	return [^(NSArray<UNNotification *> * arg0) {
		void(^Callback)(void) = ^{
			NSArray *args = nil;
...
+ (id) Block_void_____NSArray_UNNotificationRequest______:(KrollCallback *) callback {
	return [^(NSArray<UNNotificationRequest *> * arg0) {
		void(^Callback)(void) = ^{
			NSArray *args = nil;
			id _arg0 = (arg0 == nil || [(id)arg0 isEqual:[NSNull null]]) ? (id)[NSNull null] : (id)[HyperloopPointer pointer:(__bridge void *)arg0 encoding:@encode(id)];
			args = @[_arg0];
...
+ (id) Block_void_____NSSet_UNNotificationCategory______:(KrollCallback *) callback {
	return [^(NSSet<UNNotificationCategory *> * arg0) {
		void(^Callback)(void) = ^{
			NSArray *args = nil;
			id _arg0 = (arg0 == nil || [(id)arg0 isEqual:[NSNull null]]) ? (id)[NSNull null] : (id)[HyperloopPointer pointer:(__bridge void *)arg0 encoding:@encode(id)];
			args = @[_arg0];
...
+ (id) Block_void_____UNNotificationContent___:(KrollCallback *) callback {
	return [^(UNNotificationContent * arg0) {
		void(^Callback)(void) = ^{
			NSArray *args = nil;
			id _arg0 = (arg0 == nil || [(id)arg0 isEqual:[NSNull null]]) ? (id)[NSNull null] : (id)[HyperloopPointer pointer:(__bridge void *)arg0 encoding:@encode(id)];
			args = @[_arg0];
...
+ (id) Block_void_____UNNotificationPresentationOptions_:(KrollCallback *) callback {
	return [^(UNNotificationPresentationOptions arg0) {
		void(^Callback)(void) = ^{
			NSArray *args = nil;
			id _arg0 = @(arg0);
			args = @[_arg0];
...
+ (id) Block_void_____UNNotificationSettings___:(KrollCallback *) callback {
	return [^(UNNotificationSettings * arg0) {
		void(^Callback)(void) = ^{
			NSArray *args = nil;
			id _arg0 = (arg0 == nil || [(id)arg0 isEqual:[NSNull null]]) ? (id)[NSNull null] : (id)[HyperloopPointer pointer:(__bridge void *)arg0 encoding:@encode(id)];
			args = @[_arg0];
