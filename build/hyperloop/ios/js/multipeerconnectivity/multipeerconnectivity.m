...
@interface HyperloopMultipeerConnectivity : NSObject
@end

@implementation HyperloopMultipeerConnectivity
...
+ (id) Block_void_____BOOL__MCSession___:(KrollCallback *) callback {
	return [^(BOOL arg0, MCSession * arg1) {
		void(^Callback)(void) = ^{
			NSArray *args = nil;
			id _arg0 = [NSNumber numberWithBool:arg0];
