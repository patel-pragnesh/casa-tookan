...
@interface HyperloopJavaScriptCore : NSObject
@end

@implementation HyperloopJavaScriptCore




+ (id) Block_void_____JSContext____JSValue___:(KrollCallback *) callback {
	return [^(JSContext * arg0, JSValue * arg1) {
		void(^Callback)(void) = ^{
			NSArray *args = nil;
