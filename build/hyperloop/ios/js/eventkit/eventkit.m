...
@interface HyperloopEventKit : NSObject
@end

@implementation HyperloopEventKit




+ (id) Block_void_____EKEvent_____Bool___:(KrollCallback *) callback {
	return [^(EKEvent * arg0, _Bool * arg1) {
		void(^Callback)(void) = ^{
			NSArray *args = nil;
...
+ (id) Block_void_____NSArray_EKReminder______:(KrollCallback *) callback {
	return [^(NSArray<EKReminder *> * arg0) {
		void(^Callback)(void) = ^{
			NSArray *args = nil;
			id _arg0 = (arg0 == nil || [(id)arg0 isEqual:[NSNull null]]) ? (id)[NSNull null] : (id)[HyperloopPointer pointer:(__bridge void *)arg0 encoding:@encode(id)];
			args = @[_arg0];
...
+ (id) Block_void______Bool__NSError___:(KrollCallback *) callback {
	return [^(_Bool arg0, NSError * arg1) {
		void(^Callback)(void) = ^{
			NSArray *args = nil;
