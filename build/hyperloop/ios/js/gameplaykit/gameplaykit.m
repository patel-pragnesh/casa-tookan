...
@interface HyperloopGameplayKit : NSObject
@end

@implementation HyperloopGameplayKit




+ (id) Block_BOOL_____GKRuleSystem___:(KrollCallback *) callback {
	return [^(GKRuleSystem * arg0) {
		void(^Callback)(void) = ^{
			NSArray *args = nil;
...
+ (id) Block_void_____GKRuleSystem___:(KrollCallback *) callback {
	return [^(GKRuleSystem * arg0) {
		void(^Callback)(void) = ^{
			NSArray *args = nil;
			id _arg0 = (arg0 == nil || [(id)arg0 isEqual:[NSNull null]]) ? (id)[NSNull null] : (id)[HyperloopPointer pointer:(__bridge void *)arg0 encoding:@encode(id)];
