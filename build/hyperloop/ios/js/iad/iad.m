...
@interface HyperloopiAd : NSObject
@end

@implementation HyperloopiAd
...
+ (id) Block_void_____NSDate____NSDate___:(KrollCallback *) callback {
	return [^(NSDate * arg0, NSDate * arg1) {
		void(^Callback)(void) = ^{
			NSArray *args = nil;
...
+ (id) Block_void_____NSDictionary_NSString___NSObject_______NSError___:(KrollCallback *) callback {
	return [^(NSDictionary<NSString *,NSObject *> * arg0, NSError * arg1) {
		void(^Callback)(void) = ^{
			NSArray *args = nil;
			id _arg0 = (arg0 == nil || [(id)arg0 isEqual:[NSNull null]]) ? (id)[NSNull null] : (id)[HyperloopPointer pointer:(__bridge void *)arg0 encoding:@encode(id)];
			id _arg1 = (arg1 == nil || [(id)arg1 isEqual:[NSNull null]]) ? (id)[NSNull null] : (id)[HyperloopPointer pointer:(__bridge void *)arg1 encoding:@encode(id)];
