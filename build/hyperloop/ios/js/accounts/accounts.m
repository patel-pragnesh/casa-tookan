...
@interface HyperloopAccounts : NSObject
@end

@implementation HyperloopAccounts
...
+ (id) Block_void_____enum_ACAccountCredentialRenewResult__NSError___:(KrollCallback *) callback {
	return [^(enum ACAccountCredentialRenewResult arg0, NSError * arg1) {
		void(^Callback)(void) = ^{
			NSArray *args = nil;
			id _arg0 = @(arg0);
			id _arg1 = (arg1 == nil || [(id)arg1 isEqual:[NSNull null]]) ? (id)[NSNull null] : (id)[HyperloopPointer pointer:(__bridge void *)arg1 encoding:@encode(id)];
