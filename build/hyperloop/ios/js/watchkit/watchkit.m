...
@interface HyperloopWatchKit : NSObject
@end

@implementation HyperloopWatchKit




+ (id) Block_NSArray______NSString___:(KrollCallback *) callback {
...
+ (id) Block_void_____BOOL__NSTimeInterval__NSError___:(KrollCallback *) callback {
	return [^(BOOL arg0, NSTimeInterval arg1, NSError * arg2) {
		void(^Callback)(void) = ^{
			NSArray *args = nil;
			id _arg0 = [NSNumber numberWithBool:arg0];
...
+ (id) Block_void_____NSDictionary____NSError___:(KrollCallback *) callback {
	return [^(NSDictionary * arg0, NSError * arg1) {
		void(^Callback)(void) = ^{
			NSArray *args = nil;
			id _arg0 = (arg0 == nil || [(id)arg0 isEqual:[NSNull null]]) ? (id)[NSNull null] : (id)[HyperloopPointer pointer:(__bridge void *)arg0 encoding:@encode(id)];
			id _arg1 = (arg1 == nil || [(id)arg1 isEqual:[NSNull null]]) ? (id)[NSNull null] : (id)[HyperloopPointer pointer:(__bridge void *)arg1 encoding:@encode(id)];
...
+ (id) Block_void_____WKUserNotificationInterfaceType_:(KrollCallback *) callback {
	return [^(WKUserNotificationInterfaceType arg0) {
		void(^Callback)(void) = ^{
			NSArray *args = nil;
			id _arg0 = @(arg0);
			args = @[_arg0];
