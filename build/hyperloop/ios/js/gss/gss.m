...
@interface HyperloopGSS : NSObject
@end

@implementation HyperloopGSS




+ (id) Block_void_____gss_OID__gss_cred_id_t_:(KrollCallback *) callback {
	return [^(gss_OID arg0, gss_cred_id_t arg1) {
		void(^Callback)(void) = ^{
			NSArray *args = nil;
			id _arg0 = (arg0 == nil) ? (id)[NSNull null] : (id)[HyperloopPointer pointer:(const void *)&arg0 encoding:@encode(gss_OID)];
			id _arg1 = (arg1 == nil) ? (id)[NSNull null] : (id)[HyperloopPointer pointer:(const void *)&arg1 encoding:@encode(gss_cred_id_t)];
			args = @[_arg0, _arg1];
