...
@interface HyperloopCoreLocation : NSObject
@end

@implementation HyperloopCoreLocation




+ (id) Block_void_____NSArray_CLPlacemark_______NSError___:(KrollCallback *) callback {
	return [^(NSArray<CLPlacemark *> * arg0, NSError * arg1) {
		void(^Callback)(void) = ^{
			NSArray *args = nil;
