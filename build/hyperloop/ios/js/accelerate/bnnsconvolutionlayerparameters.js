 ...
 * @class
 */
function BNNSConvolutionLayerParameters (pointer) {
	if (pointer) {
		var oldWrapper = Hyperloop.getWrapper(pointer);
		if (oldWrapper) return oldWrapper;
	}
	if (!(this instanceof BNNSConvolutionLayerParameters)) { throw new TypeError('Cannot instantiate a class by calling it as a function'); }
	if (!$init) {
		$initialize();
	}
	this.$weights = {};
...
function $initialize () {
	...
	BNNSConvolutionLayerParameters._imports = $imports;

	// properties
	Object.defineProperties(BNNSConvolutionLayerParameters.prototype, {
...
module.exports = BNNSConvolutionLayerParameters;
