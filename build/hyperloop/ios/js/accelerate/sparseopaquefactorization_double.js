 ...
 * @class
 */
function SparseOpaqueFactorization_Double (pointer) {
	if (pointer) {
		var oldWrapper = Hyperloop.getWrapper(pointer);
		if (oldWrapper) return oldWrapper;
	}
	if (!(this instanceof SparseOpaqueFactorization_Double)) { throw new TypeError('Cannot instantiate a class by calling it as a function'); }
	if (!$init) {
		$initialize();
	}
	this.$attributes = {};
	...
	if (!pointer) {
		pointer = Hyperloop.createPointer('{SparseOpaqueFactorization_Double=i{?=b1b1b2b11b1}{?=iii{?=b1b1b2b11b1}CC^vQQQQ}B^vQQ}', 'Accelerate', '/Applications/Xcode.app/Contents/Developer/Platforms/iPhoneSimulator.platform/Developer/SDKs/iPhoneSimulator11.3.sdk/System/Library/Frameworks/Accelerate.framework/Frameworks/vecLib.framework/Headers/Sparse/Solve');
	}
...
function $initialize () {
	...
	SparseOpaqueFactorization_Double._imports = $imports;

	// properties
	Object.defineProperties(SparseOpaqueFactorization_Double.prototype, {
...
module.exports = SparseOpaqueFactorization_Double;
